...
function damsMessage(imgtype, badgebox, nameclass, nametext, messagetext) {
  //IMGTYPE CAN BE 1 OF 2 THINGS: " class" will let you use plugdj icons and badges, while doing "mg src" and putting a link in the badgebox var will let you put an image
