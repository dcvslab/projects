...
if (! on) {
var on = "on"
var release = "ALPHA"; var vnum = "06"; var subvnum = "5"; var commitnum = "6"; var beta = "BETA"
...
if (ulopt == "true") {
  ...
  dpsMessage("message", "dpsul", "<b>USER LEAVE</b>", "<span class='" + userlc + "'><b>" + userl.username + "</b></span><span class='dpsul'> has left <b>" + roomname + "</b></span>") 
}}
